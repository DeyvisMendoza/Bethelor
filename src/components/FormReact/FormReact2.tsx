    ...
    >
      <motion.div className="form-content" variants={contentVariants}>
        <motion.div className="form-header">
          ...
          Looking to remodel your home in Maryland? Whether you’re planning a kitchen renovation, bathroom remodel, flooring upgrade, or a whole-home improvement, the Bethelor team is here to help.
          <br></br>
          <br></br>
          With years of experience delivering quality craftsmanship and on-time results, we make your remodeling process smooth and stress-free—from the first call to project completion.
          </motion.p>
        </motion.div>
