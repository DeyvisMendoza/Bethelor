...
// Si usas TypeScript, renómbralo a .ts y añade 'export const' con un tipo adecuado
export const services = [
  {
    ...
    icons: [
      ...
      {
        icon: "/services/icon-counter.png",
  ...
  },
  {
    ...
    icons: [
      ...
      {
        icon: "/services/icon-herramienta-doble.png",
